function [vectorLen, x, lat, long, gyroAzimuth, azimuth, Orientationx, t, K, P] = heading_direction(file)
    load(file);
    ...
    figure();
    plot(t(2:vectorLen), K(2:vectorLen));
    title("Kalman Gain K over time")
    figure();
    plot(t,P);
    title("Covariance P over time")
